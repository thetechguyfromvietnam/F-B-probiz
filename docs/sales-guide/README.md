...
- Script sales qua Zalo
- Chiến lược pricing
- Xử lý objection
- KPIs và checklist

### 2. [Cách Build Website từ AI](./02-cach-build-website-tu-ai.md)
- Prompt templates
...
### 3. [Menu và Nội dung](./03-menu-va-noi-dung.md)
- Cấu trúc menu
- Content cho từng trang
- Storytelling
- Copywriting tips
- SEO content
- Checklist
...
4. Follow quy trình sales

### Để Build Website:
1. Đọc file `02-cach-build-website-tu-ai.md`
2. Sử dụng prompt templates
3. Build từng component
4. Test và deploy

### Để Tạo Nội dung:
1. Đọc file `03-menu-va-noi-dung.md`
2. Chuẩn bị menu data
